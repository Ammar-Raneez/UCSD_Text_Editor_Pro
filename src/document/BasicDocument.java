...
public class BasicDocument extends Document {
	...
	public int getNumSentences() {
		//sentences - basically everything other than ending punctuations
	...
	public static void main(String[] args) {		
		 ...
		 */
		String[] x = "%one%%two%%%three%%%%".split("[one,two,three]");
		for(String a: x) System.out.println(a);
		
		
//		double score = new BasicDocument("This is a test.  How many???  "
